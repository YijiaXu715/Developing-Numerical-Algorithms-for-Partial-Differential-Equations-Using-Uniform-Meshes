...
for j = 1:7
    ...
    fig_pos = fig.PaperPosition;
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    print(['CRate_Gin_',num2str(j)],'-dpdf');
    ...
    fig_pos = fig.PaperPosition;
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    print(['CRate_Gh_',num2str(j)],'-dpdf');
    ...
    fig_pos = fig.PaperPosition;
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    print(['CRate_Hin_',num2str(j)],'-dpdf');
    ...
    fig_pos = fig.PaperPosition;
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    print(['CRate_Hh_',num2str(j)],'-dpdf');
    ...
    fig_pos = fig.PaperPosition;
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    print(['CRateAll_',num2str(j)],'-dpdf');

    figure(7)
    loglog(Dofs,error,'k-o',Dofs,Gin_error,'r-*',Dofs,Gh_error,'b-*', ...
        Dofs,Hin_error,'m-+');
    legend('$\|u-u_h\|_{\infty,\Omega_h}$','$\|G_hu_h-\nabla u\|_{\infty,\Omega_{1,h}}$','$\|G_hu_h-\nabla u\|_{\infty,\Omega_h}$', ...
        '$\|H_hu_h-\Delta u\|_{\infty,\Omega_{1,h}}$','Interpreter','latex','Location','best');
    xlabel('Number of Degree of Freedoms');
    ylabel('Error');
    fig = gcf;
    fig.PaperPositionMode ='auto';
    ...
    for i = 1:length(h)
        fprintf('%.d & %.4e & %.2f  \n', ...
            Dofs(i), error(i), convergence_rate1(i));
    end
