...
for i=1:N
    ...
    tic
    h(i) = 10^(-i);
    [y,error(i)]=rungekutta_kutta(0,5,exp(-1),h(i),@ft,@fy);
    runtime(i) = toc;
...
ylabel('Errors');
title('Convergence Rate Analysis of Runge Kutta Kutta Fourth order Euler Method');
...
disp(['Convergence Rate of Runge Kutta Kutta Fourth Order Method: ' num2str(convergenceRate)]);
